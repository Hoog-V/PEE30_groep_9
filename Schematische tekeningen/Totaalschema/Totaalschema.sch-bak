...
F18 "VCC" U L 8175 4800 50 
F19 "VSS" U L 8175 4925 50 
F20 "VCC_ISO" U R 10275 4800 50 
F21 "VSS_ISO" U R 10275 4925 50 
F22 "Status_aandrijving_ISO_M" O R 10275 4200 50 
$EndSheet
...
U 1 1 618B8B1D
P 8175 4800
F 0 "#PWR020" H 8175 4650 50  0001 C CNN
F 1 "+3.3V" V 8190 4928 50  0000 L CNN
...
$EndComp
$Comp
L eec:+3.3V_IO1 #PWR035
U 1 1 618B9662
P 10275 4800
F 0 "#PWR035" H 10425 4750 50  0001 C CNN
F 1 "+3.3V_IO1" V 10290 4928 50  0000 L CNN
F 2 "" H 10275 4800 50  0001 C CNN
F 3 "" H 10275 4800 50  0001 C CNN
	1    10275 4800
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 618B9F26
P 10275 4925
F 0 "#PWR036" H 10275 4675 50  0001 C CNN
F 1 "GNDS" V 10280 4797 50  0000 R CNN
...
Status_belasting_ISO
$Comp
L eec:+3.3V_IO1 #PWR037
U 1 1 618C9141
P 10575 5325
F 0 "#PWR037" H 10725 5275 50  0001 C CNN
...
F1 "Voeding.sch" 50
F2 "VCC" U L 6675 2850 50 
F3 "GND" U L 6675 3325 50 
F4 "+3,3V_ISO" U R 7825 2875 50 
F5 "+3,3V" U R 7825 3175 50 
F6 "+3,3V_ISO_GND" U R 7825 2975 50 
$EndSheet
$Comp
...
Wire Wire Line
	6400 3325 6675 3325
$Comp
L eec:+3.3V_IO1 #PWR021
U 1 1 618786BE
P 7825 2875
F 0 "#PWR021" H 7975 2825 50  0001 C CNN
F 1 "+3.3V_IO1" V 7840 3003 50  0000 L CNN
F 2 "" H 7825 2875 50  0001 C CNN
F 3 "" H 7825 2875 50  0001 C CNN
	1    7825 2875
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 61878FB4
P 7825 2975
F 0 "#PWR022" H 7825 2725 50  0001 C CNN
F 1 "GNDS" V 7830 2847 50  0000 R CNN
...
U 1 1 61879740
P 7825 3175
F 0 "#PWR023" H 7825 3025 50  0001 C CNN
F 1 "+3.3V" V 7840 3303 50  0000 L CNN
...
U 1 1 619EEBD0
P 9050 1600
F 0 "#PWR024" H 9050 1350 50  0001 C CNN
...
F 1 "VCC" H 9165 923 50  0000 C CNN
...
F 1 "VCC" V 10815 2253 50  0000 L CNN
...
U 1 1 619FFC41
P 10800 2400
F 0 "#PWR018" H 10800 2150 50  0001 C CNN
...
U 1 1 61A02A05
P 6400 3325
F 0 "#PWR014" H 6400 3075 50  0001 C CNN
F 1 "GND" H 6405 3152 50  0000 C CNN
...
U 1 1 619DF8D0
P 10800 1450
F 0 "#PWR034" H 10800 1200 50  0001 C CNN
...
Wire Wire Line
	9050 1575 9050 1600
Connection ~ 9050 1575
$Comp
L power:GND #PWR010
U 1 1 619EE56E
P 5150 6475
F 0 "#PWR010" H 5150 6225 50  0001 C CNN
...
U 1 1 619EEC8E
P 5450 7475
F 0 "#PWR012" H 5450 7225 50  0001 C CNN
...
U 1 1 619F1594
P 8575 6175
F 0 "#PWR027" H 8575 5925 50  0001 C CNN
...
U 1 1 619F1EF5
P 8875 6275
F 0 "#PWR029" H 8875 6025 50  0001 C CNN
...
U 1 1 619FCA39
P 2850 7600
F 0 "#PWR07" H 2850 7350 50  0001 C CNN
...
U 1 1 619FD9DF
P 1250 7550
F 0 "#PWR04" H 1250 7300 50  0001 C CNN
...
U 1 1 61A01173
P 1375 2500
F 0 "#PWR05" H 1375 2250 50  0001 C CNN
...
U 1 1 61A01C12
P 950 2500
F 0 "#PWR02" H 950 2250 50  0001 C CNN
...
U 1 1 61A0A052
P 2700 875
F 0 "#PWR06" H 2700 625 50  0001 C CNN
...
U 1 1 61A1011A
P 8075 4925
F 0 "#PWR019" H 8075 4675 50  0001 C CNN
F 1 "GND" H 8080 4752 50  0000 C CNN
...
F7 "Noodstop_ringbus" I R 10000 2650 50 
F8 "Noodstop_ext" I L 9050 3100 50 
$EndSheet
$Comp
L power:+3.3V #PWR030
U 1 1 61B7BCA0
P 9050 2500
F 0 "#PWR030" H 9050 2350 50  0001 C CNN
...
$EndComp
$Comp
L eec:+3.3V_IO1 #PWR032
U 1 1 61B7CA29
P 9050 2750
F 0 "#PWR032" H 9200 2700 50  0001 C CNN
...
U 1 1 61B7D133
P 9050 2850
F 0 "#PWR033" H 9050 2600 50  0001 C CNN
...
U 1 1 61B5DA79
P 6525 5750
F 0 "#PWR0102" H 6525 5500 50  0001 C CNN
...
U 1 1 61B5DFE6
P 6876 5751
F 0 "#PWR0103" H 6876 5501 50  0001 C CNN
F 1 "GND" H 6881 5578 50  0000 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x20_P2.54mm_Vertical" H 5750 1550 50  0001 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x20_P2.54mm_Vertical" H 6850 1550 50  0001 C CNN
...
U 1 1 61F1F1F4
P 7345 490
F 0 "#PWR043" H 7345 240 50  0001 C CNN
F 1 "GND" H 7350 317 50  0000 C CNN
...
U 1 1 61F81021
P 7640 1315
F 0 "#PWR044" H 7640 1065 50  0001 C CNN
F 1 "GND" H 7645 1142 50  0000 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_2x06_P2.54mm_Vertical" H 7840 1015 50  0001 C CNN
